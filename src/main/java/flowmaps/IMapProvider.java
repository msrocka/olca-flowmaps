...
public interface IMapProvider {
	 ...
	 * kinds of providers that can contain multiple (e.g. a JSON-LD package),
	 * exactly one (e.g. a CSV mapping file), or no mapping definition (e.g. a
	 * standard ILCD package).
	 */
